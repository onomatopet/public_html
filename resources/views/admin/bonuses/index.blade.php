        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                ...
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-2xl font-semibold text-gray-900">
                            {{ number_format($stats['total_bonus_direct'] + $stats['total_bonus_indirect'], 0, ',', ' ') }} PV
                        </p>
                        <p class="mt-1 text-sm text-gray-600">
                            {{ number_format(($stats['total_bonus_direct'] + $stats['total_bonus_indirect']) * 500, 0, ',', ' ') }} FCFA
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-lg shadow-sm p-6">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-2xl font-semibold text-gray-900">{{ $stats['count_distributeurs'] }}</p>
                        <p class="mt-1 text-sm text-gray-600">Sur la période</p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-lg shadow-sm p-6">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-2xl font-semibold text-gray-900">
                            @if($stats['count_distributeurs'] > 0)
                                {{ number_format(($stats['total_bonus_direct'] + $stats['total_bonus_indirect']) / $stats['count_distributeurs'], 0, ',', ' ') }} PV
                            @else
                                0 €
                            @endif
                        </p>
                        <p class="mt-1 text-sm text-gray-600">Par distributeur</p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-lg shadow-sm p-6">
                <div class="flex items-center">
                    <div class="flex-shrink-0 bg-yellow-100 rounded-full p-3">
                        <svg class="h-6 w-6 text-yellow-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 9V7a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2m2 4h10a2 2 0 002-2v-6a2 2 0 00-2-2H9a2 2 0 00-2 2v6a2 2 0 002 2zm7-5a2 2 0 11-4 0 2 2 0 014 0z"/>
                        </svg>
                    </div>
                    <div class="ml-4">
                        <p class="text-sm font-medium text-gray-500">Total épargne</p>
                        <p class="mt-2 text-3xl font-bold text-gray-900">
                            {{ number_format($stats['total_epargne'], 0, ',', ' ') }} PV
                        </p>
        ...
        <div class="bg-white rounded-lg shadow-sm p-6 mb-6">
            <form method="GET" action="{{ route('admin.bonuses.index') }}" class="space-y-4">
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    {{-- Distributeur --}}
                    <div>
                        <label for="search" class="block text-sm font-medium text-gray-700 mb-1">Distributeur</label>
                        <input type="text"
                               name="search"
                               id="search"
                                ...
                                <tr class="hover:bg-gray-50 transition-colors duration-200">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-center">
                                        ...
                                        <div class="flex items-center justify-center">
                                            @for($i = 1; $i <= $bonus->distributeur->etoiles_id; $i++)
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-right text-sm text-gray-900">
                                        {{ number_format($bonus->bonus_direct, 2, ',', ' ') }} PV
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap text-right text-sm text-gray-900">
                                        {{ number_format($bonus->bonus_indirect, 2, ',', ' ') }} PV
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap text-right text-sm text-gray-900">
                                        {{ number_format($bonus->bonus_leadership, 2, ',', ' ') }} PV
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap text-right">
                                        <span class="text-sm font-bold text-green-600">
                                            {{ number_format($bonus->bonus, 2, ',', ' ') }} PV
                                        </span>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap text-right">
                                        <span class="text-sm font-bold text-green-600">
                                            {{ number_format($bonus->montant_total, 2, ',', ' ') }} FCFA
                                        </span>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                        <div class="flex items-center justify-end space-x-2">
                                            ...
                                            <a href="{{ route('admin.bonuses.imprimable', $bonus) }}"
